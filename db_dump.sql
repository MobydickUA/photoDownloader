...
--
-- Host: localhost    Database: photo_downloader
-- ------------------------------------------------------
...
CREATE DATABASE `photo_downloader` DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

USE `photo_downloader`;
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `photos` (
  `album_id` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dump completed on 2017-07-26 18:07:52
